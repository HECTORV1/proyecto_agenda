	...
	<div class="container">
		<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
			...
			<ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
				...
				@else
				<li><a href="{{ route('home') }}" class="nav-link px-2 link-secondary"><ion-icon name="calendar-outline"></ion-icon>Calendario</a></li>
				<!--<li><a href="{{ route('proyectos.index') }}" class="nav-link px-2 link-dark"><ion-icon name="folder-open-outline"></ion-icon> Proyectos</a></li> -->
				<li><a href="{{ route('tareas.index') }}" class="nav-link px-2 link-dark"><ion-icon name="list-outline"></ion-icon> Agenda</a></li>
				@endguest
			</ul>
